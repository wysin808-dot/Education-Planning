...
const ALEVEL_NAV: NavItem[] = [
  ...
  { href: "/alevel/field", zh: "由方向规划", en: "Plan from a Field", noteZh: "选定学科方向，反查院校、等级条件与分年选课", noteEn: "Choose a field and work back to universities, grade conditions and year-by-year subjects" },
